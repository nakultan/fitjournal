 ...
 * user has either never backed up or not done so in three weeks. Dismissal
 * ("Later") lasts for the session; exporting clears it for three more weeks.
 */
export function BackupReminder() {
  ...
  const overdue = useMemo(() => {
    ...
    return ageMs > REMIND_AFTER_DAYS * DAY_MS
  }, [data.lastBackupAt])
